...
public class FileListFragment extends Fragment {
    ...
    private void updateEmptyState() {
        if (adapter.getItemCount() == 0) {
            ...
            switch (fileType) {
                case "large":
                    tvEmpty.setText(getString(R.string.large));
                    break;
                case "suspicious":
                    tvEmpty.setText(getString(R.string.suspicious));
                    break;
                case "hidden":
                    tvEmpty.setText(getString(R.string.hidden));
                    break;
                default:
                    tvEmpty.setText(getString(R.string.default1));
                    break;
            }
        } else {
