...
public class CleanerMainCircularView extends View {
    private Paint bgPaint;
    private Paint progressPaint;
    private RectF oval;
    private float progress = 0f;
    private int[] gradientColors = {0xFF4B8AFF, 0xFF7B61FF, 0xFF00E0FF, 0xFF4B8AFF};
    private float strokeWidth = 48f; // Thicker stroke
    private float shadowRadius = 18f;
    private int extraPad = 40;

    public CleanerMainCircularView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
